...
open class RocketChat : Application(), HasActivityInjector, HasServiceInjector,
     ...
     */
    fun loadEmojis(context: Context) {
        ...
        currentServer?.let { server ->
            GlobalScope.launch {
                ...
                try {
                    ...
                    EmojiRepository.load(context, customEmojis = customEmojiList)
